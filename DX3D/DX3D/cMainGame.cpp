...
void cMainGame::Render()
{
	...
	g_pD3DDevice->Clear(NULL, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER,
		D3DCOLOR_XRGB(255, 224, 140), 1.0f, 0);
...
{
	D3DXCreateTextureFromFile(g_pD3DDevice, L"../img/ponyo042.png", &m_pTexture);
	ST_PT_VERTEX v;
...
{
	g_pD3DDevice->SetRenderState(D3DRS_CULLMODE, D3DCULL_NONE); // or NULL
